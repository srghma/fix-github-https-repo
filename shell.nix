{
  ...
  ghc ? pkgs.haskell.compiler.ghc864 # stack expect this file to define a function of exactly one argument that should be called ghc
}:
...
haskell.lib.buildStackProject {
  inherit ghc;
  name = "myEnv";
  buildInputs = [ cabal-install stack2nix ];
}
